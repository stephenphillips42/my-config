...
alias mydocker="pass show docker-credential-helpers/Z2hjci5pbw\=\=/USERNAME >/dev/null && cat $HOME/.config/gh/token.txt | gh auth login --with-token && docker pull ghcr.io/bdaiinstitute/dmm_amd64:main && ./docker/start.sh -d -x -b -e sphillips-dev"
